...
// Was 24. Any cell holding more than this silently drops the overflow
// particles from neighbor queries (see hash.ts insert()), which was easy to
// hit in tightly packed SPH pools or dense bursts. Doubled for headroom;
// this flows straight through to the WebGPU hash buffers too since both
// hash.ts and webgpu-backend.ts size off this same constant, so it doesn't
// need updating in more than one place.
export const HASH_MAX_PER_CELL = 48;
